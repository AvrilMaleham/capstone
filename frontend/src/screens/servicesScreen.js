  ...
  return (
    <div className="servicesScreen">
      ...
      <p className="servicespara">
        We do not believe in a one-size-fits-all service. Our training, coaching
        and consulting packages are based on a framework that is then tailored
        to each individual client’s situation, needs, and goals. We know there
        are many ways to reach an objective, and it is important that we align
        our expertise with your culture, brand, goals, and services.
      </p>
