...
function ContactScreen() {
  ...
  return (
    <div>
      ...
      <h2 className="contactScreen_title">
        We dive deeper than just looking at the parts of your business, we look
      ...
      <div className="contact-deets">
        ...
        <a href="mailto:info@edifypmconsulting.com" target="_top">
